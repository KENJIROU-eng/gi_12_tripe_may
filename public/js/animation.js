...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (container) {
        ...
        [...text[x]].forEach((char, i) => {
            ...
            div.classList.add('mx-auto', 'w-full', 'text-center', 'h-96');
            // \u00A0（ノーブレークスペース）
            ...
            if (((x == 2 || x == 3 || x == 4 ) && (i == 0)) || (x == 1 && (i == 12 || i == 13 || i == 14 || i == 15)) || (x == 0 && (i == 11 || i == 12 || i == 13 || i == 14 || i == 15 || i == 16 || i == 17 || i == 18))) {
                span.classList.add('opacity-0', 'inline-block', 'text-center', 'mx-auto', 'text-4xl', 'text-yellow-500');
            }else {
                span.classList.add('opacity-0', 'inline-block', 'text-center', 'mx-auto', 'text-4xl', 'text-white');    // 初期は非表示
            }
