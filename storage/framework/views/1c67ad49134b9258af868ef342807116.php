                        ...
                        <div class="flex ml-auto items-center">
                            <div class="col-auto bg-gray-500 rounded-full ml-4">
                                <?php if($post->user->avatar): ?>
                                    <img src="<?php echo e($post->user->avatar); ?>" alt="<?php echo e($post->user->name); ?>" class="object-cover rounded-full sm:w-11 sm:h-11 w-8 h-8">
                                <?php else: ?>
                                    <img src="<?php echo e(asset('images/ben-sweet-2LowviVHZ-E-unsplash.jpg')); ?>" alt="default avatar" class="object-cover rounded-full sm:w-11 sm:h-11 w-8 h-8">
                                <?php endif; ?>
                            </div>
                            <a href="<?php echo e(route('profile.show', $post->user->id)); ?>">
                                <div class="col-auto ml-2 text-xs sm:text-base"><?php echo e($post->user->name); ?></div>
                            </a>
                        </div>
                    </div>
