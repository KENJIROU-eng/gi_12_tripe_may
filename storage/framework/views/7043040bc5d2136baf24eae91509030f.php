                            ...
                            <div class="flex items-center justify-between bg-white rounded-lg shadow p-4 mb-4 hover:bg-gray-50 transition">
                                <a href="<?php echo e(route('profile.show', ['user_id' => $follower->follower->id])); ?>" class="flex items-center space-x-4 w-full ml-2">
                                    <?php if($follower->follower->avatar): ?>
                                        <img src="<?php echo e($follower->follower->avatar); ?>" alt="<?php echo e($follower->follower->name); ?>" class="w-12 h-12 rounded-full object-cover">
                                    <?php else: ?>
                                        <div class="w-12 h-12 bg-gray-300 rounded-full flex items-center justify-center text-white font-bold">
                                            <?php echo e(strtoupper(substr($follower->follower->name, 0, 1))); ?>

                                        </div>
                                    <?php endif; ?>

                                    <div class="text-center">
                                        <p class="font-semibold text-2xl truncate"><?php echo e($follower->follower->name); ?></p>
                                    </div>
                                </a>
                            </div>
                            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /Users/kawaimayu/Desktop/gi_12_tripe_may/resources/views/follows/follower.blade.php ENDPATH**/ ?>