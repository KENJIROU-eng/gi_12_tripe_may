                                ...
                                <tbody>
                                    <?php $__currentLoopData = $all_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e($loop->odd ? 'bg-green-100' : 'bg-green-50'); ?> text-sm sm:text-base">
                                            <td class="py-2"><?php echo e($user->id); ?></td>
                                            <td class="py-2">
                                                <?php if($user->avatar): ?>
                                                    <img src="<?php echo e($user->avatar); ?>" alt="<?php echo e($user->name); ?>" class="w-8 h-8 sm:w-10 sm:h-10 rounded-full mx-auto object-cover">
                                                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH /Users/kawaimayu/Desktop/gi_12_tripe_may/resources/views/admin/users/show.blade.php ENDPATH**/ ?>