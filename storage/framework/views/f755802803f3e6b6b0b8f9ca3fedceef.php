            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg h-full">
                <div class="p-4 text-black dark:text-gray-100 h-full">
                    ...
                    <div class="relative flex items-center justify-center h-8 my-2">
                        ...
                        <a href="<?php echo e(route('post.create')); ?>" class="ml-auto mr-3 right-40 no-underline text-end text-md sm:text-xl text-teal-500 hover:text-teal-700 bg-white border border-teal-500 hover:border-teal-700 rounded-3xl shadow-md p-2">
                                    ...
                                    <div class="relative group bg-white dark:bg-gray-700 shadow-xl overflow-hidden">
                                        ...
                                        <div class="absolute inset-0 bg-black bg-opacity-30 flex flex-col justify-end opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none">
                                            ...
                                            <div class="flex items-center px-3 pb-3 pointer-events-auto">
                                                ...
                                                <h2 class="text-xl font-bold mx-auto truncate max-w-[150px] text-white"><?php echo e($post->title); ?></h2>
...
<?php endif; ?>
<?php /**PATH C:\Users\Tamak\Desktop\gi_12_tripe_may\resources\views/posts/list.blade.php ENDPATH**/ ?>