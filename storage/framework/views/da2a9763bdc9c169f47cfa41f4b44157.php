                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                        ...
                        <div class="flex flex-col items-center">
                            ...
                            <div class="flex justify-center gap-6 mt-4 text-center text-sm sm:text-base">
                                <div>
                                    <strong><?php echo e($user->posts->count()); ?></strong><br> <?php echo e(Str::plural('Post', $user->posts->count())); ?>
                                ...
                                <div>
                                    <a href="<?php echo e(route('following.show', $user->id)); ?>" class="hover:text-blue-500">
                                        <strong><?php echo e($user->followings->count()); ?></strong><br>Following
                                    </a>
                                </div>
                            </div>
                            <?php if(Auth::id() !== $user->id): ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\Tamak\Desktop\gi_12_tripe_may\resources\views/profile/show.blade.php ENDPATH**/ ?>