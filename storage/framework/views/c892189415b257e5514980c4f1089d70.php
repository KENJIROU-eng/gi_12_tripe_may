                    ...
                    <?php if($message->message): ?>
                        <div id="message-<?php echo e($message->id); ?>" class="flex justify-end items-end">
                            <div class="text-xs text-right mt-1 text-gray-400 mr-2">
                                <div class="text-right"><?php echo e($message->created_at->format('H:i')); ?></div>
                    ...
                    <?php if($message->message): ?>
                        <div>
                            <div class="flex items-start">
                                <img src="<?php echo e($message->user->avatar_url ?? asset('images/user.png')); ?>" class="w-8 h-8 lg:w-10 lg:h-10 rounded-full mt-1" alt="<?php echo e($message->user->name); ?>">
                        ...
                        <div>
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <div class="flex space-x-2 items-end">
                                        <img src="<?php echo e($message->image_url); ?>" class="mt-1 max-w-[220px] sm:max-w-xs rounded-lg" download>
                                        <div class="text-xs text-gray-400 items-end">
                                            <div><?php echo e($message->created_at->format('H:i')); ?></div>
                                            <div><?php echo e($message->created_at->format('Y-m-d')); ?></div>
                                        </div>
...
<?php endif; ?>
<?php /**PATH /Users/kawaimayu/Desktop/gi_12_tripe_may/resources/views/groups/show.blade.php ENDPATH**/ ?>