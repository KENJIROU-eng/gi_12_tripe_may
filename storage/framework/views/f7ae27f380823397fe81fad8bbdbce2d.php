...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            ...
                            <textarea name="introduction" id="introduction" rows="4"
                                class="w-full rounded-md border-gray-300 shadow-sm focus:ring-green-500 focus:border-green-500 p-2"
                            ><?php echo e(old('introduction', $user->introduction)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-4 gap-4 items-center">
                            <div class="sm:col-span-1 flex flex-col items-center">
                                ...
                                <img id="imagePreview" src="<?php echo e($user->avatar ?? asset('images/ben-sweet-2LowviVHZ-E-unsplash.jpg')); ?>"
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="flex flex-col sm:flex-row sm:justify-between gap-4 mt-4">
                            <a href="<?php echo e(route('profile.show', $user->id)); ?>" class="w-full sm:w-1/2">
                                <button type="button"
...
<?php /**PATH /Users/kawaimayu/Desktop/gi_12_tripe_may/resources/views/profile/edit.blade.php ENDPATH**/ ?>