            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg h-full">
                <div class="p-6 text-black dark:text-gray-100">
                    ...
                    <div class="relative flex items-center justify-center h-16 my-5">
                        ...
                        <a href="<?php echo e(route('dashboard')); ?>" class="absolute right-40 inline-flex items-center px-3 py-1.5 bg-yellow-500 hover:bg-yellow-600 text-white text-sm font-semibold rounded-lg shadow">
...
<?php endif; ?>
<?php /**PATH /Users/kawaimayu/Desktop/gi_12_tripe_may/resources/views/profile/users_list.blade.php ENDPATH**/ ?>