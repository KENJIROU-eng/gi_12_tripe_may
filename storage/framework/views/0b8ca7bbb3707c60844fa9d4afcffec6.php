                ...
                <div class="bg-white/95 dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg h-full">
                    <div class=" text-black dark:text-gray-100">
                        ...
                        <div class="relative flex items-center justify-center h-16 my-5">
                            ...
                            <a href="<?php echo e(route('groups.create')); ?>" class="absolute right-4 text-sm sm:text-base lg:text-lg font-medium text-teal-500 hover:text-teal-700 bg-white border border-teal-500 hover:border-teal-700 rounded-3xl shadow-md p-2"><i class="fa-solid fa-plus"></i> New Group</a>
                        </div>
...
<?php endif; ?>
<?php /**PATH C:\Users\Tamak\Desktop\gi_12_tripe_may\resources\views/groups/list.blade.php ENDPATH**/ ?>