        ...
        <div class="pt-8 flex-1 overflow-y-auto flex flex-col lg:flex-row gap-4 max-w-screen-3xl mx-auto px-4 pb-32">
            ...
            <div class="block">
                ...
                <a href="<?php echo e($next ? route('itinerary.show', $next->id) : '#'); ?>"
                    ...
                    title="Next">
<<<<<<<< HEAD:storage/framework/views/7ee898f285a85f0f412bc967c6215cf0.php
                ...
                <a href=""
                    ...
                    title="">
========
>>>>>>>> 6df93b8a75dd54c8cbc6cfa7579d8c9215562e33:storage/framework/views/821912a324132441989f6d7ef10f83c5.php
                    <i class="fa-solid fa-chevron-left text-xl"></i>
                </a>
...
>>>>>>>> 6df93b8a75dd54c8cbc6cfa7579d8c9215562e33:storage/framework/views/821912a324132441989f6d7ef10f83c5.php
            ...
            <div class="w-full lg:w-1/5 max-w-sm order-3 lg:order-none space-y-4">
                ...
                <div class="sticky top-24 bg-white dark:bg-gray-800 border rounded p-4 shadow text-sm">
                    ...
                    <textarea id="itineraryMemo" data-save-url="<?php echo e(route('itinerary.memo.save', $itinerary->id)); ?>" data-csrf="<?php echo e(csrf_token()); ?>" class="w-full h-[70px] p-2 border rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-400 transition"><?php echo e(old('content', optional($itinerary->memo)->content)); ?></textarea>
...
========
<?php /**PATH C:\Users\USER\Desktop\gi_12_tripe_may\resources\views/itineraries/show.blade.php ENDPATH**/ ?>
>>>>>>>> 6df93b8a75dd54c8cbc6cfa7579d8c9215562e33:storage/framework/views/821912a324132441989f6d7ef10f83c5.php
