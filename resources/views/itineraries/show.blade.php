            ...
            <div class="bg-white shadow-md dark:bg-gray-800 overflow-hidden sm:rounded-lg h-full">
                <div class="p-6 text-black dark:text-gray-100">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                        {{-- 左：行程詳細 --}}
                        <div class="lg:col-span-2 flex flex-col border overflow-hidden">
                            <div class="bg-white shadow-md rounded-lg p-4 h-auto lg:h-[720px] flex flex-col">
                                {{-- Header --}}
                                <div class="grid grid-cols-5 items-center border-b pb-2">
                        ...
                        {{-- 右：グリッド表示（割り勘 / 持ち物 / マップ） --}}
                        <div class="lg:col-span-3 flex flex-col gap-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {{-- 割り勘 --}}
                                <div class="border h-auto md:h-[300px] p-2" id="goDutch-container">
                                        @include('goDutch.index', ['total_Pay' => $total_Pay, 'total_getPay' => $total_getPay])
                                </div>

                                {{-- 持ち物 --}}
                                <div class="border h-auto md:h-[300px] p-2" id="belongings-container">
                                    @include('belongings.index', ['all_belongings' => $all_belongings])
                                </div>
                            </div>

                            {{-- 地図 --}}
                            <div id="map" class="w-full border h-[300px] sm:h-[400px]">
                                map
                            </div>
                        </div>
                    </div>
