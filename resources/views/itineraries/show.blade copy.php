<x-app-layout class="overflow-hidden">
    <div class="py-10 min-h-screen bg-cover bg-center" style="background-image: url('https://res.cloudinary.com/dpwrycc89/image/upload/v1750757614/pexels-jplenio-1133505_ijwxpn.jpg');">
        <div class="flex flex-col lg:flex-row gap-4 max-w-screen-3xl mx-auto px-4">
            {{-- 前／次 フロートボタン --}}
            <div class="block">
                {{-- 前 --}}
                ...
                <div class="bg-white dark:bg-gray-800 shadow-xl rounded-lg p-4">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-5 gap-4">
                        ...
                        <div class="lg:col-span-2 flex flex-col border rounded-lg shadow-sm overflow-hidden">
                            <div class="bg-white dark:bg-gray-900 p-4 h-auto lg:h-[730px] flex flex-col">
                                {{-- Header --}}
                        ...
                        {{-- 右：割り勘／持ち物／マップ --}}
                        <div class="lg:col-span-3 flex flex-col gap-4 lg:h-[730px]">
            ...
            <div class="w-full lg:w-1/5 max-w-sm border rounded-lg shadow-md bg-white dark:bg-gray-800 p-4 h-fit order-3 lg:order-none">
                ...
                <ul id="route-steps" class="space-y-2 text-sm text-gray-700 dark:text-gray-200 overflow-y-auto max-h-[778px]">
                    {{-- JavaScriptでステップ追加 --}}
                </ul>
            </div>
        </div>
