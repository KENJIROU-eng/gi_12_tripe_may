            ...
            <div class="p-6 text-black dark:text-gray-100">
                ...
                <div class="relative flex items-center justify-center h-16 my-5">
                    ...
                    <div class="flex ml-auto items-center">
                        <div class="col-auto bg-gray-600 rounded-full w-12 h-12 ml-4"></div>
                        <a href="#">
                    ...
                    <form action="#" method="post" enctype="multipart/form-data">
                        ...
                        <div class="w-3/4 mx-auto">
                            ...
                            <div class="flex items-end gap-4 mb-4">
                                ...
                                <div class="mt-2">
                                    <img id="image-preview" class="rounded-md hidden" alt="Image Preview" style="min-width: 100px; max-width: 300px; width: auto;">
                                </div>
                            ...
                            <div class="mb-6">
                                ...
                                <textarea name="description" id="description" rows="5"
                                    class="w-full border border-gray-300 rounded px-4 py-2 focus:outline-none focus:ring focus:border-blue-200"
                            ...
                            <div class="flex justify-between">
                                ...
                                <button type="submit" class=" bg-yellow-200 px-6 py-2 text-black hover: border-yellow-200 hover:bg-white transition duration-300 rounded-md">Create Post</button>
                            </div>
                        </div>
                    </form>
                    {{--image preview--}}
