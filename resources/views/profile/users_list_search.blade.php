                        ...
                        <form action="{{ route('profile.users.search') }}" method="get" class="w-full">
                            <div class="flex">
                                <div class="flex justify-center items-center mb-3 w-full">
                                    <input type="text" name="user_name" class="w-1/2 rounded-md mr-4" value="{{ $search }}" >
                                    ...
                                    <a href="{{ route('profile.users.list') }}" class="ml-3 block text-white px-4 bg-blue-500 py-2 font-semi-bold hover: border-blue-600 hover:bg-blue-600 transition duration-300 rounded-md">View all</a>
                                </div>
                            </div>
                        </form>
